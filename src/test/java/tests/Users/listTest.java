...
public class listTest extends BaseConfiguration {
  ...
  @Test(description = "'GET(List)' test for 'Users' endpoint")
  public void listUsersTest() throws JsonSyntaxException, IOException {
    ...
    Response<List<User>> callSync = service.listUserData().execute();
